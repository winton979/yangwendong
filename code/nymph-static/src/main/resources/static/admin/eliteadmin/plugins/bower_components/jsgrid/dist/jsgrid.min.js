...
function(a, b, c) {
    ...
    d.prototype = {
        ...
        _setItemFieldValue: function(a, b, c) {
            for (var d = b.name.split("."), e = a, f = d[0]; e && d.length;) a = e,
            f = d.shift(),
            e = a[f];
            if (!e) for (; d.length;) a = a[f] = {},
            f = d.shift();
            a[f] = c
        },
        sort: function(a, c) {
        ...
        _setSortingCss: function() {
            var a = b.inArray(this._sortField, b.grep(this.fields,
            function(a) {
                return a.visible
            }));
        ...
        _createPages: function() {
            ...
            for (var e = 0,
            f = c; b > e && a >= f; e++, f++) d.push(f === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(f));
        ...
        insertItem: function(a) {
            ...
            return this._controllerCall("insertItem", c, d.cancel,
            function(a) {
                a = a || c,
        ...
        _validateItem: function(a, c) {
            ...
            if (this._eachField(function(f, g) {
                if (f.validate) {
                    ...
                    e));
                    this._setCellValidity(c.children().eq(g), h),
                    h.length && d.push.apply(d, b.map(h,
                    function(a) {
                        return {
                            field: f,
                            message: a
...
function(a, b, c) {
    ...
    d.prototype = {
        ...
        validate: function(a) {
            var c = [];
            return b.each(this._normalizeRules(a.rules),
            function(d, e) {
