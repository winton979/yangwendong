$(document).ready(function() {
    ...
    // Theme settings
    var $fixHeader=localStorage['fix-header']=='true'?true:false;
    var $fixSidebar=localStorage['fix-sidebar']=='true'?true:false;
    ...
    $("#right-side-close").click(function() {
    	$("#right-sidebar1").slideDown(50);
        $("#right-sidebar1").removeClass("shw-rside");
    })
    
    //Open-Close-right sidebar
    $("#right-side-show").click(function() {
        $("#right-sidebar1").slideDown(50);
        $("#right-sidebar1").addClass("shw-rside");

        // Fix header

        $(".fxhdr").click(function() {
        	localStorage.setItem('fix-header', !$fixHeader);
            $("body").toggleClass("fix-header");
        });
        ...
        $(".fxsdr").click(function() {
        	localStorage.setItem('fix-sidebar', !$fixSidebar);
            $("body").toggleClass("fix-sidebar");
        });
