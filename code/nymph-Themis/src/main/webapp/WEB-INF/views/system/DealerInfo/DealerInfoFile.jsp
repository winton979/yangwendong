	...
	<div class="panel panel-default">
		...
		<div class="panel-body ">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">	
			  	 <select id="orgFileTypesid" name="orgFileType" style="width:100%">
			       <c:forEach items="${dealerFileTypeMap}" var="item" >  
				...
				<label class="col-sm-1 control-label"></label>
					...
					<label class="col-sm-1 control-label"></label>
							<div class="col-sm-3">
								<a href="${ctx}/dealerInfo/dealerFileImg?sid=${orgSid}" class="btn btn-warning pull-right"  data-toggle="modal"     data-target="#showPicModal2">查看图片</a>	
							</div>
...
<script type="text/javascript">
  $(document).ready(function(){
	  ...
	  var url = "${ctx}/dealerInfo/updateFileList/${orgSid}";
	   loadingDialog();	   
  ...
  function postOrgFile(){
	  ...
	  var data = "";
	  var url = "${ctx}/dealerInfo/saveFileForm?fileSid="+fileSid+"&orgSid="+orgSid+"&orgFileType="+orgFileType;
	  if(fileSid.length == 0){
  ...
  function deletFile(sid){
	  var url = "${ctx}/dealerInfo/deleFile/"+sid+".json";
