    ...
    <table id="shTable2" class="table table-striped table-bordered 	responsive dataTable no-footer dtr-inline" role="grid">
        <thead>
            <tr>
				...
				<th><div style=""><%=DealerInfo.ALIAS_NAME%></div></th>
            ...
            <tr>
            	...
            	<td>
                   <ms:hasAnyPermission name="superAdmin,dealerInfo:update">
                   	   <a href="${ctx}/dealerInfo/updateAliasName/${item.sid}" class="btn btn-primary" data-toggle="modal" data-target=".bs-organization-edit-modal">编辑</a>
                   </ms:hasAnyPermission>
                </td>
				<td><c:out value='${item.dealerName}'/></td>
				<td><c:out value='${item.aliasName}'/></td>
