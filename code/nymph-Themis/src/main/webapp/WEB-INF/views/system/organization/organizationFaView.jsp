		...
		<div class="panel panel-default">
			...
			<div class="panel-body nopadding">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="faCode" id="selectFaCodeid2" class="width100p" placeholder="请输入所属经销商..."  value="${organization.faCode}" maxlength="64" required  disabled="true" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4" >
						<select id="SignedStatusId" data-placeholder="请选择是否签约" name="signedStatus" class="width100p"  required  disabled="true">
				...
				<c:forEach items="${carPick }" var="carPick">
						...
						<div class="form-group" >
							...
							<label class="col-sm-1 control-label">联系电话<span class="asterisk">*</span></label>
							<div class="col-sm-2">
								<input type="text" name="linkmanPhone"  class="form-control" required value="${carPick.linkmanPhone }" readonly="readonly" />
							</div>
							<label class="col-sm-1 control-label">取车点地址<span class="asterisk">*</span></label>
							<div class="col-sm-4">
...
<script type="text/javascript">
  $(document).ready(function(){
	  ...
	  initRemoteDataSelect2('selectFaCodeid2',"请选择所属经销商","${ctx}/dealerInfo/listByCodeJson.json"); 
