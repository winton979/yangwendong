		...
		<div class="x-body">
			<div class="layui-row">
				<form id="searchForm" class="layui-form layui-col-md12 x-so">
					<input class="layui-input layui-hide" value="10" name="pageSize" id="pageSize"> 
					<input class="layui-hide layui-input" value="1" name="pageNum" id="pageNumber"> 
			...
			<i class="layui-icon"></i>批量删除
				...
				<button class="layui-btn" onclick="x_admin_show('添加用户','/adminUser/add',600,400)">
