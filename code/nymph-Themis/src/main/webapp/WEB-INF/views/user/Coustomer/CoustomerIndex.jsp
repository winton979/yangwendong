...
<div class="contentpanel">
	<div class="panel panel-default">
	        ...
	        <div class="pull-right">
	        	<div class="btn-list">
	        		<ms:hasAnyPermission name="superAdmin,userInfo:create">
	        			<a href="${ctx}/coustomer/create" class="btn btn-success">创建</a>
	        		</ms:hasAnyPermission>
                </div>
	        </div>
	    ...
	    <div class="panel-body">
	        <form class="form-inline" id="searchForm" action="${ctx}/${qaction}/list?act=${act}" method="get" onsubmit="submitSearchRequest('searchForm','listDiv');return false;">
							<div class="form-group">
				                <label class="sr-only"><%=UserInfo.ALIAS_COUSTOMER_NAME%></label>
				                <input type="text" id="name" name="nameIsLike" class="form-control" placeholder="<%=UserInfo.ALIAS_COUSTOMER_NAME%>">
				            </div><!-- form-group -->
							<div class="form-group">
							...
							<div class="form-group">
				                <label class="sr-only"><%=UserInfo.ALIAS_COUSTOMER_ICON%></label>
				                <input type="text" id="icon" name="iconEqualTo" class="form-control" placeholder="<%=UserInfo.ALIAS_COUSTOMER_ICON%>">
				            </div>
							<div class="form-group">
