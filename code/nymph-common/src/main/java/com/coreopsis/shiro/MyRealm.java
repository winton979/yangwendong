...
*//**
 * 自定义的指定Shiro验证用户登录的类 暂未使用数据库权限表设计，暂时写死
 * 
...
public class MyRealm extends AuthorizingRealm {
	...
	*//**
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		 ...
		 * //为当前用户设置角色和权限 SimpleAuthorizationInfo simpleAuthorInfo = new
		 * SimpleAuthorizationInfo(); simpleAuthorInfo.addRoles(roleList); //
